        ...
        <view class="feedback">
            <view class="feedback-type">
                ...
                <view class="feedback-item" v-for="(item, index) in radios" :key="index">
                    <u-tag class="tag" :text="item.name" size="large" :plain="!item.checked" type="primary"
                        :name="index" @click="radioClick(index,item)">
                    </u-tag>
                </view>
            </view>

            <view class="feedback-content">
                <u--textarea v-model="feedback.content" :maxlength='500' :height="200" count
                    placeholder="内容を入力してください"></u--textarea>
            </view>
